$(document).ready(function() {
    ...
    //Timeline Overhaul
    $(document).on('click', '*[data-is-table-prompt]', function() {
        $(this).parent().siblings('.o-job__body__proposal__decision__table__disclaimer').toggleClass('is-masked');
    });
    $(document).on('click', '*[data-toggle-more]', function() {
        $(this).toggleClass('is-masked');
        $(this).parents('.o-job__body').children('*[data-is-more], *[data-is-less]').toggleClass('is-masked');
        $(this).siblings('*[data-toggle-less]').toggleClass('is-masked');
    });
    $(document).on('click', '*[data-toggle-less]', function() {
        $(this).toggleClass('is-masked');
        $(this).parents('.o-job__body').children('*[data-is-more], *[data-is-less]').toggleClass('is-masked');
        $(this).siblings('*[data-toggle-more]').toggleClass('is-masked');
    });
    ...
    $(".o-job__bid-equipment:gt(2), .o-job__quote-equipment:gt(2), .tenant__lease-enroll-equipment:gt(2), .o-job__body__equipment__piece:gt(2)").addClass("is-masked");
    $(".o-job__bid-equipment-truncated, .o-job__quote-equipment-truncated, .tenant__lease-enroll-equipment-truncated, .o-job__body__equipment__piece-truncated").click(function() {
        $(".o-job__bid-equipment, .o-job__quote-equipment, .tenant__lease-enroll-equipment, .o-job__body__equipment__piece").removeClass("is-masked");
        $(".o-job__bid-equipment:gt(2), .o-job__quote-equipment:gt(2), .tenant__lease-enroll-equipment:gt(2), .o-job__body__equipment__piece:gt(2)").addClass("animated fadeIn");
        $(".o-job__bid-equipment-truncated, .o-job__quote-equipment-truncated, .tenant__lease-enroll-equipment-truncated, .o-job__body__equipment__piece-truncated").addClass("is-masked");
    });
